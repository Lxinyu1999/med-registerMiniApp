...
const transformIdentifier = (node, context) => {
    return function transformIdentifier() {
        ...
        if (node.type === 5 /* INTERPOLATION */) {
            ...
            let isFilter = false;
            if (content.type === 8 /* COMPOUND_EXPRESSION */) {
                const firstChild = content.children[0];
                isFilter =
                    !(0, shared_1.isString)(firstChild) &&
                        !(0, shared_1.isSymbol)(firstChild) &&
                        firstChild.type === 4 /* SIMPLE_EXPRESSION */ &&
            ...
            const { props } = node;
            const virtualHost = !!(((_a = context.miniProgram.component) === null || _a === void 0 ? void 0 : _a.mergeVirtualHostAttributes) &&
